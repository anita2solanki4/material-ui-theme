  ...
  render() {
    ...
    return (
      ...
      <div>
        ...
        <h4>Structure</h4>
        <p>A data table contains a header row at the top that lists column names, followed by rows for data.</p>
        ...
        <h3>Sorting & Selecting</h3>
        <p>This example demonstrates the use Checkbox and clickable rows for selection with a Toolbar.</p>
        <p>It uses the TableSortLabel component to help style column headings.</p>
        ...
        <p>For more advanced use cases you might be able to take advantage of dx-react-grid-material-ui. It's a data grid for Material-UI with paging, sorting, filtering, grouping and editing features.</p>
